        ...
        <div class="panel panel-primary">
            <div class="panel-heading"><h3 class="panel-title"><span class="glyphicon glyphicon-download-alt" aria-hidden="true"></span>&nbsp;Cadastro de Clientes</h3></div>
                <div class="panel-body">
                    <form name="cadcliente" id="cadcliente" action="cadastracliente.php" method="post">
                        <label>Nome</label>
                        <input type="text" name="nome" placeholder="Digite o nome" maxlength="85" required="required" class="form-control">
                        <label>Renda</label>
                        <h5><input type="decimal" name="renda" placeholder="Digite a renda" maxlength="30" class="form-control"><h5>
                        <label>Credito</label>
                        <h5><input type="decimal" name="credito" placeholder="Digite o credito" maxlength="30" required="required" class="form-control"><h5>
                        <label>CPF</label>
