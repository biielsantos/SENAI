...
<html>
    ...
    <body>
        ...
        <br> <br>
        <center><a href="addprodutos.php"><button class="btn btn-primary"><b>Carrinho de pedidos</b></button></a></center>
        <?php
            include("conecta.php");
            echo "<h4>Produtos<h4>";
            ...
            echo "<tr>";
                ...
                echo "<td><a href='produtos.php?id=$id'><button type='submit' class='btn btn-success'>Adicionar</button></a>&nbsp;&nbsp;<a href='editarproduto.php?id=$id'><button type='submit' class='btn btn-success'>Editar</button></a>&nbsp;&nbsp;<a href='apagaproduto.php?id=$id'><button type='submit' class='btn btn-danger'>Apagar</button></a></td>";
            echo"</tr>";
            }
            mysqli_close($conn);
        ?>
