...
<html>
    ...
    <body>
        <header>
        <div class="col-md-4 col-md-offset-4"><h3>prova</h3></div>
        <br/><br/>
        </header>
        <nav>
        <hr/>
        <div class="col-xs-8 col-xs-offset-2">
           ...
           <div style="width: 35%; float:left; padding-left:65%;">
           <?php
        ...
        <footer>
        <div style="position: fixed; left: 0; bottom: 0; width: 100%; background-color: DodgerBlue; color: white; text-align: center;">prova - Versão 1.0</div>
        </footer>
    </body>
</html>